...
<body>
  ...
  <div style="width:70% ; margin-left:8%; margin-right:10%; text-align:justify;">
    ...
    <div style="margin-left:10% ;">
      ...
      <br>
      <button class="btn btn-secondary btn-tam" style="margin-left:35% ;">
        <a href="http://www.fatecid.com.br/site/wp-content/uploads/downloads/secretaria/regimento-fatecs%202016.pdf" target="_black">Regimento</a>
      </button>
    </div>
  </div>
