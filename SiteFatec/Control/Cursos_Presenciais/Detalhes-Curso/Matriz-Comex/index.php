  ...
  <div class="buttons-modal">
    ...
    <div class="containerButtons2">
      <button type="button" data-toggle="modal" data-target="#exampleModal3" id="radius-button" class="button-in-modal">
        <i class="fa-solid fa-user"></i>
        <br>
        Mercado e Finanças Internacionais
      </button>
    ...
    <nav class="nav-pag" aria-label="...">
      <ul class="pagination">
        <li class="page-item"><a class="page-link" href="../../comex.php">Voltar</a>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Projeto em Comércio Exterior</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Projeto em Comércio Exterior</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Política Comercial Externa</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>...</strong>Política Comercial Externa<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Economia Internacional</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Economia Internacional</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Mercado e Finanças Internacionais</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Mercado e Finanças Internacionais</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Sistemática do Comércio Exterior</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Sistemática do Comércio Exterior</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Legislação Aduaneira</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Legislação Aduaneira</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Teoria e Prática Cambial</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Teoria e Prática Cambial</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Negócios Internacionais</h5>
          </div>
          <div class="modal-body">
            <p>Na matéria de <strong>Negócios Internacionais</strong> você irá aprender..<br><br>
              <strong>Professor(a):</strong> ... <Br>
              <strong>Lates:</strong><a href="#" target="_blank">VEJA AQUI</a>
          </div>
          <div class="modal-footer">
