...
<body>
    <div class="conteudo-total">
        ...
        <div class="side-and-iframe">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/06KsM4PHlzk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="side-right">
                <h2>Informações:</h2>
                <div class="sub-info">
                    <i class="fa-solid fa-circle-check"></i>
                    <span>Coordenador do curso: <strong>Michel Moron Munhoz</strong></span>
                </div>
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
                    <span>Matriz Curricular: <a href="./Detalhes-Curso/Matriz-ADS/index.php">VEJA AQUI</a></span>
                </div>
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
                    <span>Horário de monitoria: <a href="http://www.fatecid.com.br/site/wp-content/uploads/2022/03/Horario-Monitoria-2022-1.pdf" target="_black">VEJA AQUI</a></span>
                </div>
            </div>
        ...
        <div class="list-of-buttons">
            ...
            <!--<a href="../Matriz-ADS/index.html">
              <button type="button" data-toggle="modal" data-target="#exampleModal4" id="radius-button">
                <i class="fa-solid fa-user"></i>
                <br>
                Grade
              </button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>O curso de <strong>Análise e Desenvolvimento de Sistemas</strong> forma profissionais capazes de desenvolver, analisar, projetar, implementar e atualizar sistemas de informação para diversos setores de atividades.<br><br>Por se tratar de uma formação de tecnólogo, a faculdade é voltada para o mercado de trabalho e a grade curricular oferece ao aluno a oportunidade de estudar disciplinas práticas em atividades normalmente exigidas pelas empresas.
                    </div>
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Como Análista/Desenvolvedor de Software, você pode trabalhar em:<br>
                            &nbsp &nbsp - Empresas de Tecnologia Nacionais e Internacionais, como a <strong>Google</strong> ou <strong>Microsoft,</strong><br>
                            &nbsp &nbsp - Institutos e centros de pesquisas<br>
                            &nbsp &nbsp - ONGs<br>
                            &nbsp &nbsp - Instituições de ensino<br>
                            &nbsp &nbsp - Orgãos publicos<br>
                            <br>E você pode atuar como:<br>
                            &nbsp &nbsp - Desenvolvedor de software BackEnd<br>
                            &nbsp &nbsp - Desenvolvedor de software FrontEnd<br>
                            &nbsp &nbsp - Desenvolvedor de software FullStack<br>
                            &nbsp &nbsp - DevOps<br>
                            &nbsp &nbsp - UI/UX Design<br>
                            &nbsp &nbsp - Análista de software.
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
        ...
        <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Perfil do profissional de ADS</h5>
                    </div>
                    <div class="modal-body">
                        O Perfil do profissional de ADS bate com alguns dos Soft e Hard Skills mencionados abaixo:<br>
                        &nbsp &nbsp - Comunicativo<br>
                        &nbsp &nbsp - Trabalho em equipe<br>
                        &nbsp &nbsp - Resiliência<br>
                        &nbsp &nbsp - Lógica<br>
                        &nbsp &nbsp - Capacidade de aprendizado<br>
