...
<body>
    ...
    <div class="side-and-iframe">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/sVbB3keDjgU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <div class="side-right">
            ...
            <div class="sub-info">
                <i class="fa-solid fa-user-graduate"></i>
                <span>Matriz Curricular: <a href="Detalhes-Curso/Matriz-Redes/index.php">VEJA AQUI</a></span>
