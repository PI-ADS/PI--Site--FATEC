...
<div class="container">
    <div class="row text-center mb-4">
        <div class="col-md-12">
            <br>
            <img src="../../View/img/logo2.jpg" height="60" width="350">
        </div>
    </div>
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-primary btn-dark" href="../../../SiteFatec/index.php" role="button">Voltar</a>
                </div>
            </div>
        </div>
    </div>
            ...
            while ($sql = mysqli_fetch_array($query)) {
                if ($sql["RA"] == $login && $sql["SENHA"] == $senha) {
                    ...
                    echo '<font face=verdana size=3 color=red><center> <br><br>
                         <img src="../../View/img/carregando.gif"></font></center>
