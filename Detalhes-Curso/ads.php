...
<body>
    <div class="conteudo-total">
        ...
        <div class="side-and-iframe">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/06KsM4PHlzk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>      <div class="side-right">
                <h2>Informações:</h2>
                <div class="sub-info">
                    <i class="fa-solid fa-circle-check"></i>
                ...
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
                    <span>Matriz Curricular: <a href="../Matriz-ADS/index.html">VEJA AQUI</a></span>
                </div>
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
                    <span>Horário de monitoria: <a href="http://www.fatecid.com.br/site/wp-content/uploads/2022/03/Horario-Monitoria-2022-1.pdf">VEJA AQUI</a></span>
                </div>
            </div>
