...
<body>
    ...
    <div class="side-and-iframe">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/sVbB3keDjgU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        <div class="side-right">
            <h2>Informações:</h2>
            <div class="sub-info">
                <i class="fa-solid fa-circle-check"></i>
                <span>Coordenador do curso: <strong>Janaine Arantes</strong></span>
            </div>
            <div class="sub-info">
                <i class="fa-solid fa-user-graduate"></i>
                <span>Matriz Curricular: <a href="../Matriz-Redes/index.html">VEJA AQUI</a></span>
    ...
    <div class="list-of-buttons">
        ...
        <!-- <a href="http://www.fatecid.com.br/site/wp-content/uploads/2022/02/Horario-Redes-14-02-22.pdf" class="grade" target="_blank">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    O curso de Redes de Computadores destina-se ao público com interesse em Exatas, eletrônica e computação. As áreas de atuação estendem-se desde o desenvolvimento de projetos físicos e lógicos, aplicativos voltados para redes e web, configuração, administração e segurança de redes, até para novas tendências apresentadas pelo mercado como Internet das Coisas e Computação em Nuvem.
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    O mercado de trabalho deste profissional é bastante diversificado, podendo atuar em empresas relacionadas à área de tecnologia da informação ou ainda, em empresas públicas e privadas que fazem uso de tecnologia da informação em seu cotidiano, englobando todos os setores de serviços e de produção.
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Perfil do profissional de redes</h5>
                </div>
                <div class="modal-body">
                    Listar opções perfil
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                </div>
