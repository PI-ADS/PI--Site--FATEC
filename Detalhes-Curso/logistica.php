...
<body>
    <!--<div class="conteudo-total">
        ...
        <div class="side-and-iframe">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/4nSqFi0V29w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>      <div class="side-right">
                <h2>Informações:</h2>
                <div class="sub-info">
                    <i class="fa-solid fa-circle-check"></i>
                ...
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
                    <span>Matriz Curricular: <a href="../Matriz-Logistica/index.html">VEJA AQUI</a></span>
                </div>
                <div class="sub-info">
                    <i class="fa-solid fa-user-graduate"></i>
